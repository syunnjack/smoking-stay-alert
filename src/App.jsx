...
const saveKey = 'smoking-stay-alert.saved'
const postKey = 'smoking-stay-alert.posts'
const alerts = [
  {
    "id": "smoking-stay-alert-1",
    "title": "喫煙可 alert seed 1",
    "area": "名古屋",
    "category": "喫煙可",
    "score": 95,
    "summary": "喫煙可、バストイレ付き、深夜チェックインなど条件特化の空室通知で宿泊予約へ送客するサービス。 喫煙可の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X"
    ],
  ...
  {
    "id": "smoking-stay-alert-2",
    "title": "バストイレ付き alert seed 2",
    "area": "東京",
    "category": "バストイレ付き",
    "score": 92,
    "summary": "喫煙可、バストイレ付き、深夜チェックインなど条件特化の空室通知で宿泊予約へ送客するサービス。 バストイレ付きの条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X",
      "メール"
  ...
  {
    "id": "smoking-stay-alert-3",
    "title": "深夜チェックイン alert seed 3",
    "area": "大阪",
    "category": "深夜チェックイン",
    "score": 89,
    "summary": "喫煙可、バストイレ付き、深夜チェックインなど条件特化の空室通知で宿泊予約へ送客するサービス。 深夜チェックインの条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X",
      "メール",
  ...
  {
    "id": "smoking-stay-alert-4",
    "title": "駅近 alert seed 4",
    "area": "静岡",
    "category": "駅近",
    "score": 86,
    "summary": "喫煙可、バストイレ付き、深夜チェックインなど条件特化の空室通知で宿泊予約へ送客するサービス。 駅近の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X"
    ],
  ...
  return (
    <main className="app-shell">
      <section className="hero">
        <div>
          <p className="eyebrow">喫煙可ホテル・バストイレ付き宿通知</p>
          <h1>Smoking Stay Alert</h1>
          <p className="lead">喫煙可、バストイレ付き、深夜チェックインなど条件特化の空室通知で宿泊予約へ送客するサービス。</p>
        </div>
        <aside className="hero-panel">
          <span>smokingstay.jp / smoking-stay-alert</span>
